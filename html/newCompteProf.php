...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 if(empty($validationErrors)){
    if(search_using_email($email)==0){
        $query= $pdo->prepare("INSERT INTO eleve(nom,prenom,genre,birthday,number,identifiant,email,pwd,etat) 
        VALUES(:pnom,:pprenom,:pgenre,:pbirthday,:pnumber,:pidentifiant,:pemail,:ppwd,:petat)");
...
<div class="container col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
        <div class="panel panel-primary margetop60">
            ...
            <form method="POST" class="form" action ="newCompte.php">
                ...
                <div class="form-group">
                    <label for="ide">Entrez Votre code secret</label>
